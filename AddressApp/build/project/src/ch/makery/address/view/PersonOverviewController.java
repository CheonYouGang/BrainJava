...
public class PersonOverviewController {
	// 매핑역할: 테이블에 데이터를 보여주기 위한 클래스(컨트롤러)
	// Overview의 컨트롤러
	@FXML
	// fxml 파일에서 모든 설정을 마치고 나서, 이 파일이 로드될 때 애플리케이션은 각 필드에 값을 자동으로 채웁니다
...
//		}
	    ...
	    if (selectedIndex >= 0) {
	        ...
	        alert.initOwner(mainApp.getPrimaryStage());
	        alert.setTitle("No Selection");
	        alert.setHeaderText("더 이상 삭제할 수 없습니다.");
	        alert.setContentText("Please select a person in the table.");
	...
	// 출처: http://code.makery.ch/library/javafx-8-tutorial/kr/part1/
}
