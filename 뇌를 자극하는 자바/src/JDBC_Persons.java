...
/*	Persons persons;      		//래퍼런스 변수 선언
	persons = new Persons();	//객체생성 = new 연산자
*/	
	//persons객체에 멤버필드를 셋팅
/*	persons.setJumincd("456789-9123456");
	persons.setPname("Jong");
	persons.setGender("M");
	persons.setAge(10);*/
	
/*	System.out.println(persons.getAge());*/
	
/*	System.out.println(persons.jumincd);
	System.out.println(persons.pname);
